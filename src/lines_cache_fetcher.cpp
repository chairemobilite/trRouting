...
namespace TrRouting
{
  ...
  const std::pair<std::vector<Line>, std::map<boost::uuids::uuid, int>> CacheFetcher::getLines(std::map<boost::uuids::uuid, int> agencyIndexesByUuid, std::map<std::string, int> modeIndexesByShortname, Parameters& params)
  { 
