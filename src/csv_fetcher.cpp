...
namespace TrRouting
{
  ...
  const std::pair<std::vector<Stop>, std::map<unsigned long long, int>> CsvFetcher::getStops(std::string applicationShortname)
  {
  ...
  const std::pair<std::vector<Route>, std::map<unsigned long long, int>> CsvFetcher::getRoutes(std::string applicationShortname)
  {
  ...
  const std::pair<std::vector<Trip>, std::map<unsigned long long, int>> CsvFetcher::getTrips(std::string applicationShortname)
  {
  ...
  const std::pair<std::vector<std::tuple<int,int,int>>, std::vector<std::pair<long long,long long>>> CsvFetcher::getFootpaths(std::string applicationShortname, std::map<unsigned long long, int> stopIndexesById)
  {
