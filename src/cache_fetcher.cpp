...
namespace TrRouting
{
  ...
  const std::pair<std::vector<std::tuple<int,int,int,int,int,short,short>>, std::vector<std::tuple<int,int,int,int,int,short,short>>> CacheFetcher::getConnections(std::string applicationShortname, std::map<unsigned long long, int> stopIndexesById, std::map<unsigned long long, int> tripIndexesById)
  {
    ...
    if (cacheFileExists(applicationShortname, "connections_forward"))
    {
  ...
  const std::pair<std::vector<std::tuple<int,int,int>>, std::vector<std::pair<int,int>>> CacheFetcher::getFootpaths(std::string applicationShortname, std::map<unsigned long long, int> stopIndexesById, int maxTransferWalkingTravelTimeSeconds)
  {
    ...
    if (cacheFileExists(applicationShortname, "footpaths"))
    {
    ...
    if (cacheFileExists(applicationShortname, "footpaths_ranges"))
    {
