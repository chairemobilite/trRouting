...
CAPNP_DECLARE_SCHEMA(b03326c4149f8dc8);
CAPNP_DECLARE_SCHEMA(ae0002d27ded297e);
...
struct NodeCollection {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(b03326c4149f8dc8, 0, 1)
    #if !CAPNP_LITE
...
class NodeCollection::Reader {
public:
  typedef NodeCollection Reads;
  ...
  inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Reader getNodes() const;
...
class NodeCollection::Builder {
public:
  typedef NodeCollection Builds;
  ...
  inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Builder getNodes();
  inline void setNodes( ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Reader value);
  inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Builder initNodes(unsigned int size);
  inline void adoptNodes(::capnp::Orphan< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>> disownNodes();
...
#if !CAPNP_LITE
class NodeCollection::Pipeline {
public:
  typedef NodeCollection Pipelines;
...
inline bool NodeCollection::Reader::hasNodes() const {
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool NodeCollection::Builder::hasNodes() {
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Reader NodeCollection::Reader::getNodes() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Builder NodeCollection::Builder::getNodes() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void NodeCollection::Builder::setNodes( ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>::Builder NodeCollection::Builder::initNodes(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), size);
}
inline void NodeCollection::Builder::adoptNodes(
    ::capnp::Orphan< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>> NodeCollection::Builder::disownNodes() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::nodeCollection::Node,  ::capnp::Kind::STRUCT>>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
