...
#ifndef CAPNP_INCLUDED_8ffad6ff4ac3568a_
#define CAPNP_INCLUDED_8ffad6ff4ac3568a_
...
public:
  ...
  inline  ::capnp::List< ::odTripsCollection::OdTrip>::Reader getOdTrips() const;
...
public:
  ...
  inline  ::capnp::List< ::odTripsCollection::OdTrip>::Builder getOdTrips();
  inline void setOdTrips( ::capnp::List< ::odTripsCollection::OdTrip>::Reader value);
  inline  ::capnp::List< ::odTripsCollection::OdTrip>::Builder initOdTrips(unsigned int size);
  inline void adoptOdTrips(::capnp::Orphan< ::capnp::List< ::odTripsCollection::OdTrip>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::odTripsCollection::OdTrip>> disownOdTrips();
...
inline  ::capnp::List< ::odTripsCollection::OdTrip>::Reader OdTripsCollection::Reader::getOdTrips() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::odTripsCollection::OdTrip>::Builder OdTripsCollection::Builder::getOdTrips() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void OdTripsCollection::Builder::setOdTrips( ::capnp::List< ::odTripsCollection::OdTrip>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::odTripsCollection::OdTrip>::Builder OdTripsCollection::Builder::initOdTrips(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), size);
}
inline void OdTripsCollection::Builder::adoptOdTrips(
    ::capnp::Orphan< ::capnp::List< ::odTripsCollection::OdTrip>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::odTripsCollection::OdTrip>> OdTripsCollection::Builder::disownOdTrips() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::odTripsCollection::OdTrip>>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
...
#endif  // CAPNP_INCLUDED_8ffad6ff4ac3568a_
