...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "dTripFootpath\022\020\n\010stop_idx\030\001 \001(\005\022\023\n\013trave"
      "l_time\030\002 \001(\005b\006proto3"
  };
...
void ProtoOdTripFootpath::SerializeWithCachedSizes(
  ...
  // int32 stop_idx = 1;
  if (this->stop_idx() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->stop_idx(), output);
  }

  // int32 travel_time = 2;
  if (this->travel_time() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->travel_time(), output);
  }
...
::google::protobuf::uint8* ProtoOdTripFootpath::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 stop_idx = 1;
  if (this->stop_idx() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(1, this->stop_idx(), target);
  }

  // int32 travel_time = 2;
  if (this->travel_time() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->travel_time(), target);
  }
