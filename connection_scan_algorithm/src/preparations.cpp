...
namespace TrRouting
{
  ...
  void Calculator::prepare()
  {
    ...
    {
      std::tie(agencies, agencyIndexesByUuid)                = params.cacheFetcher->getAgencies(params.applicationShortname);
      //std::tie(nodes, nodeIndexesById)                   = params.cacheFetcher->getNodes(params.applicationShortname);
      ...
      //{
      //  std::tie(odTrips, odTripIndexesById, odTripFootpaths) = params.databaseFetcher->getOdTrips(params.applicationShortname, nodes, params);
      //}
      //else
      //{
      //  std::tie(odTrips, odTripIndexesById)             = params.cacheFetcher->getOdTrips(params.applicationShortname, nodes, params);
      //  odTripFootpaths                                  = params.cacheFetcher->getOdTripFootpaths(params.applicationShortname, params);
      //}
      ...
      //std::tie(forwardConnections, reverseConnections)   = params.cacheFetcher->getConnections(params.applicationShortname, nodeIndexesById, tripIndexesById);
      //std::tie(footpaths, footpathsRanges)               = params.cacheFetcher->getFootpaths(params.applicationShortname, nodeIndexesById);
    }
    //else if (params.dataFetcherShortname == "gtfs")
    //{
    //  std::tie(nodes, nodeIndexesById)                 = params.gtfsFetcher->getNodes(params.applicationShortname);
    ...
    //  std::tie(forwardConnections, reverseConnections) = params.gtfsFetcher->getConnections(params.applicationShortname, nodeIndexesById, tripIndexesById);
    //  std::tie(footpaths, footpathsRanges)             = params.gtfsFetcher->getFootpaths(params.applicationShortname, nodeIndexesById);
    //}
    //else if (params.dataFetcherShortname == "csv")
    //{
    //  std::tie(nodes, nodeIndexesById)                 = params.csvFetcher->getNodes(params.applicationShortname);
    ...
    //  std::tie(forwardConnections, reverseConnections) = params.csvFetcher->getConnections(params.applicationShortname, nodeIndexesById, tripIndexesById);
    //  std::tie(footpaths, footpathsRanges)             = params.csvFetcher->getFootpaths(params.applicationShortname, nodeIndexesById);
    //}
